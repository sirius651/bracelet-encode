...
const uauth = new UAuthConnector({
  uauth: new UAuth({
    clientID: process.env.NEXT_PUBLIC_UA_CLIENT_ID!,
    redirectUri: process.env.NEXT_PUBLIC_UA_REDIRECT_URI!,
    postLogoutRedirectUri: process.env.NEXT_PUBLIC_UA_REDIRECT_URI!,
    scope: 'openid wallet',
  }),
...
export default function ConnectButton() {
  ...
  async function connectUnstoppable() {
